export default [
	...
	{ data: () => import('./BitsyHD.8.1.hbs'), bitsyVersion: '8.1', isHd: true, description: 'Bitsy HD (Bitsy 8.0)' },
	{ data: () => import('./Bitsy.8.1.hbs'), bitsyVersion: '8.1', description: 'Bitsy 8.1', isDefault: true },
